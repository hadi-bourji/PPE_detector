...
def main(weight_path, device = "cuda", validation = True):
    if validation:
        ...
        id3, img3, label3 = dataset[43]
        id4, img4, label4 = dataset[44]
        id5, img5, label5 = dataset[78]
        id6, img6, label6 = dataset[81]
        id7, img7, label7 = dataset[82]
        id8, img8, label8 = dataset[83]
        id9, img9, label9 = dataset[80]
        id10, img10, label10 = dataset[79]
        ...
        img1, label1 = dataset[43]
        img2, label2 = dataset[44]
        img3, label3 = dataset[45]
    ...
    if validation:
        ...
        for id, img in zip(ids, images):
            ...
            PPE_DATA.show_img(img.squeeze(0), processed_preds, f"output_images/all_data/val_img{id}_200.png", 
        ...
        for id, img, label in zip(ids, images, labels):
            ...
            outputs[...,4:].sigmoid_()
            processed_preds = post_process_img(outputs[0], confidence_threshold=0.25, iou_threshold=0.5)
            processed_preds = torch.empty(0, 5)
...
if __name__ == "__main__":
    main("model_checkpoints/yolox_s_nc4_ep300_bs16_lr1e-04_wd5e-04_07-08_00.pth", device = "cuda",
          validation = True)
